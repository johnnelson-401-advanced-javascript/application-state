...
describe('Moods', () => {
  describe('mood selectors', () => {
    ...
    it.skip('is angry if hungry', () => {
      expect(getFace({ coffees: 1, naps: 0, snacks: 0, studies: 0 })).toEqual('😡');
    });

    it.skip('is happy if not tired, hungry, educated, or hungry', () => {
